...
#3. test tcp server
g++ test_tcpserver.cpp ../tcpserver.cpp ../log.c ../pb/netmessage.pb.cc -o test_tcpserver --std=c++0x -I../ -I/usr/local/include  -L/usr/local/lib -lpthread -luv -lssl -lcrypto -lprotobuf
